...
export const TRANSLATIONS = {
  ja: {
    ...
    form_cast_placeholder: '例: 山田太郎, 鈴木花子 (カンマ区切り)',
    form_cast_kana_placeholder: '例: やまだたろう, すずきはなこ (カンマ区切り)',
  ...
  en: {
    ...
    key_modal_cast_kana_placeholder: 'e.g., Yamada Taro, Suzuki Hanako (comma separated)',
    ...
    form_cast_placeholder: 'e.g., Taro Yamada, Hanako Suzuki (comma separated)',
    form_cast_kana_placeholder: 'e.g., yamada taro, suzuki hanako (comma separated)',
