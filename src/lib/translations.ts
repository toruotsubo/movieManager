...
export const TRANSLATIONS = {
  ja: {
    ...
    settings_section2: '2. キー項目の選択と項目の並び替え',
    settings_section2_desc: 'メインインデックスで使用するキー項目を1つ選択してください。タイトルと評価以外の項目はドラッグして表示順を変更できます。',
    settings_section3: '3. 言語設定',
    settings_section3_desc: '表示言語を選択してください。「自動」を選択するとOSの言語設定が適用されます。',
    ...
    key_modal_cast_kana_label: '主演（ふりがな）',
    key_modal_cast_kana_placeholder: '例: やまだたろう, すずきはなこ',
    key_modal_rating_label: 'キー項目の評価 (5段階)',
  ...
  en: {
    ...
    settings_section2: '2. Select key items and sort them',
    ...
    settings_section3_desc: 'Select the display language. "Auto" applies the OS language setting.',
    ...
    key_modal_cast_kana_label: 'Cast (Kana)',
    key_modal_cast_kana_placeholder: 'e.g., Yamada Taro, Suzuki Hanako',
    key_modal_rating_label: 'Key Item Rating (5 levels)',
    ...
    form_rating_label: 'Rating (5 levels)',
    ...
    form_cast_placeholder: 'e.g., Taro Yamada, Hanako Suzuki',
    form_cast_kana_placeholder: 'e.g., yamada taro, suzuki hanako',
    form_genre_placeholder: 'e.g., Action, Documentary',
    form_release_year_label: 'Release Year (YYYY)',
    form_release_year_placeholder: 'e.g., 2024',
